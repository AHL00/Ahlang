...
impl<'a> Lexer<'a> {
    ...
    pub fn lex(source: &'a str) -> Result<Vec<Token<'a>>, LexerError> {
        let mut lexer = Self {
            tokens: Vec::new(),
            current: 0,
            line: 1,
            ...
            if let Some(c) = lexer.consume_char() {
                ...
                if c.is_alphabetic() {
                    ...
                    if identifier == "true" || identifier == "false" {
                        lexer.push_token(TokenType::Literal(Literal::Boolean(identifier)));
                        continue;
                    }
                ...
                if c.is_numeric() {
                    ...
                    if contains_decimal {
                        ...
                        lexer.push_token(TokenType::Literal(Literal::Integer(number_str)));
                    }
                ...
                if c == '"' {
                    ...
                    lexer.push_token(TokenType::Literal(Literal::String(string_literal)));
                    ...
                    '-' => {
                        if let Some(c) = lexer.peek() {
                            if *c == '=' {
                                ...
                                lexer.push_token(TokenType::Operator(Operator::Subtract));
                            }
                        } else {
                            lexer.push_token(TokenType::Operator(Operator::Subtract));
                        }
                    ...
                    '*' => {
                        if let Some(c) = lexer.peek() {
                            if *c == '=' {
                                ...
                                lexer.push_token(TokenType::Operator(Operator::Multiply));
                            }
                        } else {
                            lexer.push_token(TokenType::Operator(Operator::Multiply));
                        }
                    ...
                    '/' => {
                        if let Some(c) = lexer.peek() {
                            if *c == '=' {
                                ...
                                lexer.push_token(TokenType::Operator(Operator::Divide));
                            }
                        } else {
                            lexer.push_token(TokenType::Operator(Operator::Divide));
                        }
                    ...
                    '%' => {
                        if let Some(c) = lexer.peek() {
                            if *c == '=' {
                                ...
                                lexer.push_token(TokenType::Operator(Operator::Modulo));
                            }
                        } else {
                            lexer.push_token(TokenType::Operator(Operator::Modulo));
                        }
...
mod tests {
    ...
    fn test_lex() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                TokenType::Literal(Literal::Integer("5")),
    ...
    fn test_string_literal() {
        ...
        assert_eq!(
            token_type_vec,
            vec![
                TokenType::Literal(Literal::String("Hello, world!")),
                TokenType::Punctuation(Punctuation::Semicolon),
            ]
        );
    }
